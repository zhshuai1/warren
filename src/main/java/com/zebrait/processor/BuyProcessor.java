...
@Log4j2
public class BuyProcessor extends AbstractProcessor {
    ...
    public void process(Object param) {
        ...
        for (StockStatusEntry stockStatusEntry : candidates) {
            ...
            if (strategy.checkBuy(dataProvider.getStockInfo(code))) {
                ...
                log.info("Will  buy {} for strategy {}", code, strategy.getClass().getName());
            } else {
                log.info("Will not buy {} for strategy {}", code, strategy.getClass().getName());
            }
        }
